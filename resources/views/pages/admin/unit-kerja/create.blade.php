        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Unit Kerja</h1>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('unit-kerja.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Tautan"
                                    required>
                                <label for="" class="mt-3">Alamat</label>
                                <input type="text" name="alamat" class="form-control" placeholder="Masukkan Alamat">
                                <label for="" class="mt-3">Tugas</label>
                                <textarea name="tugas" id="editor2" cols="30" rows="10"></textarea>
