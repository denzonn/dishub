        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Sosial Media</h1>

                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin-media-sosial-update', $media->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <label for="">Nama Sosial Media</label>
                                <input type="text" name="nama_sosmed" class="form-control"
                                    placeholder="Masukkan Nama Sosial Media" value="{{ $media->nama_sosmed }}" required>
                                <label for="" class="mt-3">Link Sosial Media</label>
                                <input type="text" name="link_sosmed" value="{{ $media->link_sosmed }}"
                                    class="form-control" placeholder="Masukkan Link Sosial Media" required>
                                <label for="" class="mt-3">Icon Sosial Media</label>
                                <div class="mb-4" style="color: red">*Jika tidak ingin mengganti icon tidak perlu upload
                                    foto</div>
                                <div>
                                    <input type="file" name="icon_sosmed">
                                </div>
